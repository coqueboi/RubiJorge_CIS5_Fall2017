...
int main() {
    ...
    bool orient; //Position switch for Horizontal or Vertical ships
    ...
    ship1,ship2,ship3,ship4,ship5 = true; //Initialize ship creation functions
    ...
    do{
        for(short y=0; y<10; y++){
            ...
            for(short x=0; x<10; x++){
                ...
                //if(board[y][x] == '1' ie:for hidden ships?
                else{
                    board[y][x] = {'O'};
                }
